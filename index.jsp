...
<style>
    * {
    ...
    .weatherIcon img {
        max-width: 100%;
        width: 8rem;
        filter: drop-shadow(10px 10px 10px black); /* Ensured consistent drop shadow */
    }
...
<body>
    <div class="mainContainer">
        ...
        <form action="MyServlet" method="post" class="searchInput">
            <input type="text" placeholder="Enter City Name" id="searchInput" value="Enter The City Name" name="city"/>
            <button id="searchButton"><i class="fa-solid fa-magnifying-glass"></i></button>
        </form>
        <!-- End of the form section -->

        <!-- Start of the weather details section -->
        <div class="weatherDetails">
            ...
            <div class="cityDetails">        
                ...
                <div class="date"><span id="current-time"></span></div>
            </div>
        ...
        <!-- End of the weather details section -->
    </div>
    <script>
